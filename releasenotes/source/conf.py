# -*- coding: utf-8 -*-
#
# Coverage2sql Release Notes documentation build configuration file, created by
...
release = version.VersionInfo('coverage2sql').version_string_with_vcs()
# The short X.Y version.
version = version.VersionInfo('coverage2sql').canonical_version_string()
...
htmlhelp_basename = 'Coverage2sqlReleaseNotesdoc'
